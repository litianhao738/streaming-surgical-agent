# Streaming SurgicalAgent: unified five-head Gate pipeline

The default pipeline uses the retrained `five-head-unified-gate-20260916` Gate.
...
The separate pre-Gate Qwen probe remains. RAM is disabled.
