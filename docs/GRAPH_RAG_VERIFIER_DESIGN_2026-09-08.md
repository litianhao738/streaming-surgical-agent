...
后续项目级架构见 [Final-only Pipeline 加入 GraphRAG 的项目架构](architecture/FINAL_ONLY_GRAPH_RAG_ARCHITECTURE_2026-09-08.md)：明确 Gate 在候选／检索之前、知识包由五席使用、Repair 的接纳权限，以及离线建库、Memory、代码接口和完整四格实验的边界。该文同样是尚未实现的设计。
